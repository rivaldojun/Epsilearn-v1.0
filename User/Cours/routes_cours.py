...
def offreprof() :
        ...
        if request.method == 'POST':
            ...
            # Exemple de recherche en fonction du critère 'nom_offre':
...
def traiter_offre():
    ...
    if request.method == 'POST':
        ...
        # Récupérez les séances (jour + heure) depuis le formulaire
        seances = []
        seances_presentiel = []
        jours_abreges = {
    'lundi': 'Lun',
    ...
    'dimanche': 'Dim'
        ...
        if 'image_1' in request.files and 'image_2' in request.files:
            ...
            if allowed_file(image_1.filename) and allowed_file(image_2.filename):
                ...
                path1 = "User/static"  # Chemin vers le répertoire "static" de votre application
