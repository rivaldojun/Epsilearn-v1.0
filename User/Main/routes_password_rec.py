...
def password_reset(token):
    ...
    # If the token is invalid or has expired, show an error message or redirect to a suitable page.
    return redirect(url_for('Main.invalid_token'))  # Redirect to a page displaying an error message about the invalid token.
