...
def create_app(conf=None):
    ...
    app.config.from_object(
        f'User.Configuration.config.Config{conf.capitalize()}'
    )
    ...
    from User.Main import MainBp
    app.register_blueprint(MainBp)
    from User.Admin import AdminBp
    app.register_blueprint(AdminBp)
    from User.Cours import CoursBp
    app.register_blueprint(CoursBp)
    from User.Event import EventBp
    app.register_blueprint(EventBp)
    from User.Pomodoro import PomodoroBp
